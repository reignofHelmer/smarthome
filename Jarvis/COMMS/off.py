...
folder = r"C:\Users\MICHEAL\Desktop\CD3\MY CODING FILES\Jarvis\Jarvis\audiocomms\offlight"
os.makedirs(folder, exist_ok=True)

def get_next_filename(base_name="turn_off_light", extension="wav"):
...
try:
    while True:
        next_file = get_next_filename("turn_off_light")
