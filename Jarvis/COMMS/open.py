...
folder = r"C:\Users\MICHEAL\Desktop\CD3\MY CODING FILES\Jarvis\Jarvis\audiocomms\opendoor"
os.makedirs(folder, exist_ok=True)

def get_next_filename(base_name="open_door", extension="wav"):
...
try:
    while True:
        next_file = get_next_filename("open_door")
