...
folder = r"C:\Users\MICHEAL\Desktop\CD3\MY CODING FILES\Jarvis\Jarvis\audiocomms\lockdoor"
os.makedirs(folder, exist_ok=True)

def get_next_filename(base_name="lock_the_door", extension="wav"):
...
try:
    while True:
        next_file = get_next_filename("lock_the_door")
